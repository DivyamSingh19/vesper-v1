...
const AboutCard = ({ className }: props) => {
  ...
  return (
    <Card
      className={`max-w-full p-4 sm:p-6 md:p-10 rounded-2xl ${className || ""}`}
    >
      ...
      <CardContent className="flex flex-col lg:flex-row lg:justify-between gap-5 lg:gap-8">
        <div className="flex flex-col gap-3 md:gap-5 lg:max-w-5xl lg:w-full font-sans text-sm sm:text-base md:text-lg lg:text-xl order-2 lg:order-1">
          <p className="leading-relaxed">
            ...
            summarization and interactive flowchart generation for personalized
            legal guidance.
          </p>
          <p className="leading-relaxed">
            The platform features complete multilingual support, text-to-speech
            and speech-to-text capabilities for accessibility, and leverages
            IPFS blockchain technology for secure, tamper-proof document storage
            and one-click encrypted sharing between clients and legal teams.
          </p>
          <p className="leading-relaxed">
            With integrated appointment booking systems for both legal
            professionals and clients, Vesper's core mission is to decode
            complex legal jargon into understandable language, ensuring everyone
            knows their rights regardless of their background or abilities,
            while providing free, universal access to legal care and eliminating
            barriers to justice through technology-driven solutions.
          </p>
        </div>
